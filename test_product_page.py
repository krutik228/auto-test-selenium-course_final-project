...
def test_guest_cant_see_success_message_after_adding_product_to_basket(browser):
    ...
    page.open()
    page.add_product_to_cart()
    assert page.is_not_element_present(*ProductPageLocators.NOTIFICATION_OF_ADDING_A_PRODUCT_TO_CART), \
...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    page.open()
    page.add_product_to_cart()
    assert page.is_disappeared(*ProductPageLocators.NOTIFICATION_OF_ADDING_A_PRODUCT_TO_CART), \
